...
class ShopNavbar extends React.Component {
    ...
    // loadClothing = () => {
    //     console.log("Trying to Load Clothes");
    //     API.getClothes().then(res => this.setState({clothing: res.data, type: "", price: "", sizes: "", quantity: "", image: ""})
